...
public class MaskWithLetter {
    ...
    public static void main(String[] args) {
        ...
        SetDefinition setDefinition = separateNum.getSetDefinition();
        setDefinition.setDigits(maskWithLetter.MaskDigit("ABCDEFGHIJ"),1);
        setDefinition.setDot(maskWithLetter.maskDot("K"),0);
        setDefinition.setExponents(maskWithLetter.maskExponents("L"),0);
        setDefinition.setPlusAndMinus(maskWithLetter.maskPlusAndMinus("MN"),1 );
        setDefinition.setMask(maskWithLetter.mask);
